...
- (void)setText:(NSString*)text {
	if ([text isEqualToString:@""]) {
		if (((IAWTokenField*)self.superview.superview).numberOfToken > 0) {
			text = @"\u200B";
		}
	}
	[super setText:text];
...
@interface IAWTokenField () <UITextFieldDelegate>
{
